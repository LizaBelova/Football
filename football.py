...
liverpool = ['Liverpool','SADIO MANE','ROBERTO FIRMINO','JORDAN HENDERSON','MOHAMED SALAH','NABY KEITA','FABINHO','IBRAHIMA KONATE','JOEL MATIP','VIRGIL VAN DIJK','JAMES MILNER','ALISSON BECKER']
southampton = ['Southampton','Каррильо Гидо','Буфаль Софиан','Лемина Марио','Уорд-Праус Джеймс','Ромеу Ориоль','Тадич Душан','Худт Веслей','Стивенс Джек','Седрик Суареш','Бертран Райан','Алекс Маккарти']
#italian teams
...
def select_team():
 ...
 checker2 = True
 checker = None
 teams = {'BARCELONA':barcelona,'MADRID':madrid,'VALENCIA':valencia,'ATLETICO MADRID':amadrid,'SEVILLA':sevilla,'MANCHESTER CITY':manc,'MANCHESTER UNITED':manu,'CHELSEA':chelsea,'TOTTENHAM':tottenham,'LIVERPOOL':liverpool,'SOUTHAMPTON':southampton,'NAPOLI':napoli,'JUVENTUS':juventus,'INTER MILAN':inter,'AS ROMA':roma,'LAZLO':lazlo}
